...
public class FormUkuran extends JInternalFrame{
  private Anggota anggota = new Anggota();
  private FormLihatUkuran FormLihatUkuran = new FormLihatUkuran(null,true);

  public FormUkuran(){
    super("Master Data Ukuran", true, true);
  ...
  private void lihatButtonActionPerformed(ActionEvent evt){
    FormLihatUkuran.tampilkanData(anggota.bacaData());
	FormLihatUkuran.setVisible(true);

	if (!FormLihatUkuran.getKodeDipilih().equals("")){
	  kodeAnggotaTextField.setText(FormLihatUkuran.getKodeDipilih());
	  cariAnggota(kodeAnggotaTextField.getText());
	}
  }
