...
public class FormSepatu extends JInternalFrame{
  private Anggota anggota = new Anggota();
  private FormLihatSepatu formLihatSepatu = new FormLihatSepatu(null,true);

  public FormSepatu(){
    super("Master Data Sepatu", true, true);
  ...
  private void inisialisasiKomponen(){
	...
	kodeAnggotaLabel = new JLabel("Nama Produk");
	namaAnggotaLabel = new JLabel("Merk");
	alamatAnggotaLabel = new JLabel("Harga");
  ...
  private void lihatButtonActionPerformed(ActionEvent evt){
    formLihatSepatu.tampilkanData(anggota.bacaData());
    formLihatSepatu.setVisible(true);
    if (!formLihatSepatu.getKodeDipilih().equals("")){
      kodeAnggotaTextField.setText(formLihatSepatu.getKodeDipilih());
      cariAnggota(kodeAnggotaTextField.getText());
    }
  }
